...
def generate_launch_description():
    """Sadece HW, Perception, Path Planner ve PID Kontrolcüyü başlatır."""
    return LaunchDescription([
        # Donanım Arayüzü (HW Interface)
        Node(
        ...
        # PID Kontrolcü (Direksiyon + Hız kontrolü)
        Node(
